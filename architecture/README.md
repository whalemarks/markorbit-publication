...
The current Canon remains the accepted working baseline until an Owner-approved amendment is merged. The pending ADR identifies an upstream conflict affecting Workplace and MGSN definitions; Book 07 Charter progression is paused pending the ADR decision and reconciliation.

The current Canon is not a final published edition, not a Book 02 semantic amendment, and not implementation or external protected-action authorization.
