...
| Book 06 | MarkOrbit Lite | `book-06-markorbit-lite/` | Product Baseline v0.1 — Owner Accepted on Merge |
...
Book 06 has an accepted Product Charter v0.3 and a candidate Product Baseline v0.1. Owner merge accepts B06-SPEC-0001–0004, the `ML-*` controlled ranges, four reference journeys, 24 conformance scenarios, Handoff contracts, MVP criteria and historical V1 reconciliation. It then authorizes a Chapter Map Candidate. No chapter map or manuscript has been accepted.
