...
| Book 06 | MarkOrbit Lite | `book-06-markorbit-lite/` | Chapter Map v0.1 — Owner Accepted on Merge |
...
Book 06 has accepted Product Charter v0.3 and Product Baseline v0.1. The current Chapter Map candidate establishes B06-TOC-V0.1, CH00–CH33, seven Parts and seven controlled drafting waves. Owner merge authorizes Wave 1 manuscript drafting for CH00–CH06. No manuscript chapter has yet been created.
