...
| Book 04 | MarkOrbit Workplace and Product Architecture | `book-04-workplace-product-architecture/` | Scaffolded Planning Baseline; directory created; manuscript not started |
...
Book 02 remains frozen. Future Book 02 semantic changes require the existing Change Proposal process. Book 05–07 directories remain intentionally uncreated.
